"""
Intent: Recently my brother and I talked about computer vision which inspired me to try more computer vision projects. 
Previously, I created motion and face detection for a bigger home security system project. 
My high school math mentioned I should program some sort of simulator to solve the Rubik's cube.
I can solve the cube much faster than I can program a machine to solve the cube. 
Now that my coding is a little more advanced, I'd like to take on this challenge.
I think OpenCV should be sufficient for this task. 
...
import numpy as np
import kociemba as Cube #pip3 install kociemba or pip install kociemba (http://kociemba.org/, https://hcie.csail.mit.edu/classes/2018-fall-6810/6810-install-rubik-cube-library)
import time
import colorama #pip install colorama
from colorama import init
from colorama import Fore, Back, Style

#https://github.com/nicpatel963/CubeSolvingScript
...
print("")
print("")
print(f"{magenta}Please refer to the preview window for which surfacae to be scanned.")
